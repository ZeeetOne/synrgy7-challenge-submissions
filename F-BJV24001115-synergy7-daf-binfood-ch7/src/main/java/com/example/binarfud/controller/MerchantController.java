...
import com.example.binarfud.kafka.producer.MessageProducer;
...
public class MerchantController {
    ...
    public ResponseEntity<Map<String, Object>> saveMerchant(@RequestBody MerchantRequestCreateDto merchantRequestCreateDto) {
        ...
        Merchant savedMerchant = merchantService.saveMerchant(merchantRequestCreateDto);

        Map<String, Object> data = new HashMap<>();
        data.put("merchant", savedMerchant);
        response.put("data", data);

        String message = "New merchant created with ID: " + savedMerchant.getId();
        messageProducer.sendMessage("new-merchant", message);
